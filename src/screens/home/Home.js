...
class Home extends Component
{
 ...
 return(
      <div>
          <Header showSearchBox="true" showProfilePic="true" myAccount="true" pictureUrl={this.state.profile_picture} parentCallback = {this.callbackFunction}/>
         {this.state.searchString==='' ?
        <Box p={(1, 2)}>
        <Grid container justify-self="end" spacing={1} align-self="end">
            {this.state.usersData.map((card) => (
                <Grid alignContent="center" key={card.id} item lg={6} align-self="end">
